/*
    Spektrum SRXL2 Protocol structures, types, etc.

    Copyright 2025 AESilky (SilkyDESIGN)
    SPDX-License-Identifier: MIT

    Some portions Copyright (c) 2019-2023 Horizon Hobby, LLC
    SPDX-License-Identifier: MIT
*/
#ifndef SRXL2_T_H_
#define SRXL2_T_H_
...
// Set SRXL_CRC_OPTIMIZE_MODE to one of the following values
