...
const uint8_t ili9341_init_cmd_data[] = {
    ...
    ILI_CASET   , 4, 0x00,              // Column Addr Set: SC=0 EC=00EF (239) for 240 columns
                        0x00,
                        0x00,
                        0xEF,
    ILI_PASET   , 4, 0x00,              // Page Addr Set: SP=0 EP=013F (319) for 320 rows
                        0x00,
                        0x01,
                        0x3F,
    ...
    // ILI_EC_DFUNCTL , 4, 0x08,              // Function Ctl: Non-Disp Inverval Scan, V63/V0, VCH/VCL,
