...
void tp_module_init(int sample_size, uint16_t display_height, uint16_t display_width, uint64_t x_factor, int16_t x_offset, uint64_t y_factor, int16_t y_offset) {
